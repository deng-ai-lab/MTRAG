...
def expand2square_cv(img, background_color=(0, 0, 0)):
    ...
    result = cv2.copyMakeBorder(img, pad_top, pad_bottom, pad_left, pad_right,
...
def process_images(images, image_processor, model_cfg):
    ...
    if image_aspect_ratio == 'pad':
        for image in images:
            image = expand2square_cv(image, tuple(int(x*255) for x in image_processor.image_mean))
